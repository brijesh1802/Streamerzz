    ...
    <section>
        <div className='max-w-7xl mx-auto px-4 mt-20'>
            <div className='text-center mb-12 border-t border-neutral-800'>
                <h2 className='text-3xl lg:text-5xl bg-clip-text text-transparent mt-20 tracking-lighter bg-gradient-to-t from-neutral-50 via-neutral-300 to-neutral-600 '>
