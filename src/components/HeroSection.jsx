  ...
  return (
    <section className='pt-28 lg:pt-36'>
        <div className='max-w-7xl mx-auto px-4 flex flex-col items-center text-center'>
            ...
            <div className="mit-6 space-x-4 space-y-5">
                <a href='#' className='inline-block bg-blue-600 hover:bg-blue-500 text-white py-3 px-8 rounded-lg font-medium'>
            ...
            <div className="mt-12">
                <img src={heroImage} alt="Streamer Saas Interface" className='w-full h0auto rounded-3xl border border-neutral-800 mb-20' />
            </div>
        </div>
        </section>
  )
